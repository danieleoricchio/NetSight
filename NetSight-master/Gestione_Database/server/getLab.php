<?php
    ...
    if (!isset($_GET['name']) || empty($_GET['name'])) die(json_encode(new JsonMessage(400, "Parametro 'name' non inserito", false,null)));
    $nome = $_GET['name'];
    ...
    if($result= mysqli_query($link,$sql)){
        ...
        if (count($all)==0){
            die(json_encode(new JsonMessage(204, "Impossibile trovare laboratorio $nome", false,null)));
        }
